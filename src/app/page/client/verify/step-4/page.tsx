...
export default function Step4Page() {
  ...
  function handleSubmit() {
    // Placeholder submit action (replace later)
    console.log("Submit for review (mock)");
    alert("Submitted for review (mock). Replace this logic later.");
  }
    ...
    <main className="bg-gray-50 min-h-screen px-4 py-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div
              ...
              onKeyDown={(e) =>
                handleKeyboardActivate(e, () => router.push("../verify/step-1"))
              }
          ...
          <div className="flex items-center justify-between py-1">
            ...
            <div className="text-sm text-gray-400 select-none cursor-not-allowed">Edit</div>
          </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4 text-sm text-blue-700">
          ...
          <p className="mt-2">
            Our team will review your documents within 24–48 hours. You will receive
            an email notification once your verification is complete. You can
            track the status in your account settings.
          </p>
        </div>
