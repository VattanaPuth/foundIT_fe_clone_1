...
// Filename: Plan.tsx — Pricing section (fixed TSX)
...
const TIERS: Tier[] = [
    ...
    },
    {
        ...
        priceMonthly: 39,
        priceAnnual: 32, // discounted monthly equivalent when billed annually
            ...
            <div className="mx-auto text-center">
                ...
                <div className="mt-6 flex w-fit items-center mx-auto rounded-full bg-gray-100 px-3 text-sm">
                    <div className="flex items-center justify-center">
                        ...
                        <p
                            className={`rounded-full px-4 py-2 pt-2 mt-3 transition ${
                            billing === "monthly" ? "text-white bg-[#101828] shadow-sm" : "opacity-70 hover:opacity-100"
                            }`}
                        ...
                        <p
                            className={`rounded-full px-4 py-2 mt-3 transition ${
                            billing === "annual" ? "text-white bg-[#101828] shadow-sm" : "opacity-70 hover:opacity-100"
                            }`}
                ...
                return (
                    <div
                        ...
                        className={[
                            ...
                            emphasized ? "border-gray-300 shadow-xl ring-1 ring-gray-200" : "border-gray-200 shadow-sm",
                        ].join(" ")}
                        >
                        {emphasized && (
                            <span className="absolute left-1/2 top-0 z-10 -translate-y-1/2 -translate-x-1/2 rounded-full bg-gray-900 px-3 py-1 text-xs font-medium text-white">
                                Most Popular
                            </span>
                        )}
                        ...
                        <div className="p-6">
                            ...
                            <p className="mt-1 max-w-xs text-xs leading-relaxed text-gray-500">{tier.blurb}</p>
                            ...
                            <div className="mt-4">
                                {tier.cta.href ? (
                                    ...
                                    href={tier.cta.href}
                                    className={[
                                        "block w-full rounded-md px-4 py-2 text-center text-sm font-medium !no-underline hover:!no-underline focus:!no-underline",
                            ...
                            {tier.featureIntro && (
                                <div className="mt-6 whitespace-pre-line text-xs text-gray-500">{tier.featureIntro}</div>
                            )}

                            <ul className="mt-2 space-y-3">
                                {tier.features.map((f, idx) => (
                                    <li key={idx} className="flex items-start gap-3">
                                    {f.included ? <Check className="mt-0.5 text-gray-900" /> : <Cross className="mt-0.5 text-gray-300" />}
                                    <span
                                        className={[
                                        "text-sm",
