        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          <div className="mt-6 flex-1 flex flex-col items-center justify-center text-center">
            ...
            <div className="h-12 w-12 rounded-xl border border-gray-200 bg-gray-50 grid place-items-center text-gray-700">
              ...
              >
                <path
                  d="M16 4H6.66667C5.95942 4 5.28115 4.28095 4.78105 4.78105C4.28095 5.28115 4 5.95942 4 6.66667V25.3333C4 26.0406 4.28095 26.7189 4.78105 27.219C5.28115 27.719 5.95942 28 6.66667 28H25.3333C26.0406 28 26.7189 27.719 27.219 27.219C27.719 26.7189 28 26.0406 28 25.3333V16"
                  stroke="#717182"
        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          <div className="mt-6 flex-1 flex flex-col items-center justify-center text-center">
            ...
            <div className="h-12 w-12 rounded-xl border border-gray-200 bg-white grid place-items-center text-blue-600">
              ...
              >
                <path
                  d="M16.0013 29.3346C23.3651 29.3346 29.3346 23.3651 29.3346 16.0013C29.3346 8.63751 23.3651 2.66797 16.0013 2.66797C8.63751 2.66797 2.66797 8.63751 2.66797 16.0013C2.66797 23.3651 8.63751 29.3346 16.0013 29.3346Z"
                  stroke="#155DFC"
                  stroke-width="2.66667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
